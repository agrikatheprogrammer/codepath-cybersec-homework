...
The exported JSON file has the records of the details of the attacks - the date, the protocol, the source ip, source port, destination port, and the honeypot I deployed/was attacked.
