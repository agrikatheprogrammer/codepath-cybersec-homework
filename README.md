...
The exported JSON file is a record of the details of the attacks - the date, the protocol, the source ip, source port, destination port, and the honeypot I deployed/was attacked.
